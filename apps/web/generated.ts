// Generated by @wagmi/cli@1.3.0 on 7/22/2023 at 7:21:58 PM
import {
  useContractRead,
...
/**
 * [__View Contract on Polygon Mumbai Polygon Scan__](https://mumbai.polygonscan.com/address/0x195F3cdE1CB48Ab724f68bADfe3165937710A678)
 */
...
export const leP2PEscrowAddress = {
  80001: '0x195F3cdE1CB48Ab724f68bADfe3165937710A678',
} as const
...
/**
 * [__View Contract on Polygon Mumbai Polygon Scan__](https://mumbai.polygonscan.com/address/0xfB82aEe8C684b03Bc2dcCcD221ff104f8A31fDAe)
 */
...
export const usdcMockAddress = {
  80001: '0xfB82aEe8C684b03Bc2dcCcD221ff104f8A31fDAe',
} as const
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link circuitMockABI}__.
 */
export function useCircuitMockRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof circuitMockABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof circuitMockABI, TFunctionName, TSelectData>,
    'abi'
  > = {} as any,
) {
  return useContractRead({
    abi: circuitMockABI,
    ...config,
  } as UseContractReadConfig<typeof circuitMockABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link circuitMockABI}__ and `functionName` set to `"getChallengeInputIndex"`.
 */
export function useCircuitMockGetChallengeInputIndex<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link circuitMockABI}__ and `functionName` set to `"getCircuitId"`.
 */
export function useCircuitMockGetCircuitId<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link circuitMockABI}__ and `functionName` set to `"verify"`.
 */
export function useCircuitMockVerify<
